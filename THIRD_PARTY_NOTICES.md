...
This project uses third-party open source components via Swift Package Manager and checked-in developer tooling packages.
The lists below are generated from the SwiftPM `Package.resolved` files, Xcode project package references, and `BuildTools/Package.swift`.
